...
import { parseVoteAndConfidence } from './services/geminiService';
...
// ============================================================================
const SERIES_A_RESPONSES: Record<string, string> = {
...
// ============================================================================
const ENTERPRISE_VS_PLG_RESPONSES: Record<string, string> = {
...
// ============================================================================
const ARTICULATE_RESPONSE: Record<string, string> = {
...
// ============================================================================
const INTERNATIONAL_EXPANSION_RESPONSES: Record<string, string> = {
...
// ============================================================================
const AI_MODEL_STRATEGY_RESPONSES: Record<string, string> = {
...
// ============================================================================
export const getMockMessages = (scenarioIndex: number): Message[] => {
  const scenario = MOCK_SCENARIOS[scenarioIndex];
  if (!scenario) return [];

  const baseTime = Date.now();
  const mode: 'SMS' | 'DASHBOARD' = scenario.question.split(/\s+/).length >= 30 ? 'DASHBOARD' : 'SMS';

  const makeMsg = (role: AgentRole, offset: number): Message => {
